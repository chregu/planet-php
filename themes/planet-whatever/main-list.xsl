    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <xsl:call-template name="htmlhead"/>
              ...
              <body id="blogug-ch"  onload="enableTooltips()">
              <div id="wrap">
...
<div id="footer">
    <p>
  <b>Design is not finished, we're working on it...</b></p>
  <p>
    swiss blogs data from  <a href="http://list.blogug.ch/">list.blogug.ch</a> and <a href="http://blog.ch/">blog.ch</a>. 
  
    </p>

    <p>Created and maintained by <a href="http://chregu.tv/">Christian Stocker</a>. Design originally by <a href="http://sis.slowli.com">sis</a>, but this release is not yet approved by him.
...
urchinTracker();
    ...
    <xsl:template name="rightcol">
        <div id="rightcol">
            <div class="menu">
                <fieldset>
                    <legend>Search the Planet </legend>
                    ...
                    <a id="searchbarLink" href="/s/searchoptions.html">Search Options</a>
                    <br clear="right"/>
